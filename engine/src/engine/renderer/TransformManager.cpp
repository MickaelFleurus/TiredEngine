...
// // This should only be called before resolving the transforms, not every time
// a
// // parent changes
...
//                 }
//                 mBases[id.index].mWorld = mBases[id.index].mLocal *
//                 parentWorld;
//             }
//         }
//     }
...
// void CTransformManager::Clone(Core::GameObjectId dest, Core::GameObjectId
// src) {
