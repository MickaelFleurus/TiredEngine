...
//     ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(0.15f, 0.15f,
//     0.15f, 1.0f)); ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(8,
//     8));
...
//     bool isOpen =
//         ImGui::TreeNodeEx(magic_enum::enum_name(componentType).data(),
//         flags);
...
//         ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.8f, 0.1f, 0.1f,
//         0.8f)); ImGui::PushStyleColor(ImGuiCol_ButtonHovered,
...
//     ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(0.1f, 0.1f, 0.1f,
//     0.95f)); ImGui::PushStyleColor(ImGuiCol_ChildBg, ImVec4(0.12f, 0.12f,
//     0.12f, 1.0f));
